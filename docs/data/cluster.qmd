...
`book-links/isbn-clusters.parquet`{#file-book-links-isbn-clusters-parquet}
...
`book-links/cluster-graph-nodes.parquet`{#file-book-links-cluster-graph-nodes-parquet}
:   The table of nodes (with attributes) from the graph used for book clustering.


`book-links/cluster-graph-edges.parquet`{#file-book-links-cluster-graph-edges-parquet}
:   The table of edges rom the book clustering graph.


`book-links/book-graph.mp.zst`{#file-book-links-book-graph.mp-zst}
...
`book-links/cluster-first-authors.parquet`{#file-book-links-cluster-first-authors-parquet}
:   All available first-author records for each cluster, to support linking with VIAF.


`book-links/cluster-hashes.parquet`{#file-book-links-cluster-hashes-parquet}
...
`book-links/cluster-stats.parquet`{#file-book-links-cluster-stats-parquet}
