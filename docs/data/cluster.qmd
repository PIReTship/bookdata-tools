...
`book-links/isbn-clusters.parquet`{#file:isbn-clusters.parquet}
...
`book-links/cluster-first-authors.parquet`{#file:cluster-first-authors.parquet}
:   All available first-author records for each cluster, to support linking with VIAF.

    {{< schema book-links/cluster-first-authors.parquet >}}

`book-links/cluster-hashes.parquet`{#file:cluster-hashes.parquet}
...
`dcode` that is the least-significant bit of the checksum.
    ...
    {{< schema book-links/cluster-hashes.parquet >}}

`book-links/cluster-stats.parquet`{#file:cluster-stats.parquet}
:   Statistics for each cluster, useful for auditing and debugging.

    {{< schema book-links/cluster-stats.parquet >}}
