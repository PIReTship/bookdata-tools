...
`loc-mds/book-fields.parquet`{#file:book-fields.parquet}
...
`loc-mds/book-ids.parquet`{#file:book-ids.parquet}
:   This table includes code information for each book record.
    ...
    {{< schema loc-mds/book-ids.parquet >}}

`loc-mds/book-isbns.parquet`{#file:book-isbns.parquet}
...
It is defined by {{< rust-struct ~bookdata::marc::book_fields::ISBNrec >}}.
    ...
    {{< schema loc-mds/book-isbns.parquet >}}


`loc-mds/book-isbn-ids.parquet`{#file:book-isbn-ids.parquet}
...
ISBN IDs.
    ...
    {{< schema loc-mds/book-isbn-ids.parquet >}}


`loc-mds/book-authors.parquet`{#file:book-authors.parquet}
:   Author names for book records.  This only extracts the primary author name (MARC field 100 subfield ‘a’).

    {{< schema loc-mds/book-authors.parquet >}}
