...
`scan-authors`
:   Import the VIAF MARC data into `viaf/viaf.parquet`{.file}.

`author-genders`
:   Extract author genders from the VIAF MARC data, producing `author-genders.parquet`{.file}.

`index-names`
:   Normalize and expand author names and map to VIAF record IDs, producing `author-name-index.parquet`{.file}.
...
`viaf/viaf.parquet`{#file-viaf-viaf-parquet}
...
`viaf/author-name-index.parquet`{#file-viaf-author-name-index-parquet}
...
`viaf/author-genders.parquet`{#file-viaf-author-genders-parquet}
