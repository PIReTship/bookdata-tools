...
`scan-authors`
:   Import the VIAF MARC data into {{< file viaf.parquet >}}.
...
`viaf/viaf.parquet`{#file:viaf.parquet}
...
`viaf/author-name-index.parquet`{#file:author-name-index.parquet}
...
`viaf/author-genders.parquet`{#file:author-genders.parquet}
