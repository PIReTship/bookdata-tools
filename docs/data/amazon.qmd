...
`az2014/ratings.parquet`{#file:ratings.parquet}
:   The raw rating data, with user strings converted to numeric IDs, is in this file.

`az2018/ratings.parquet`{#file:ratings.parquet}
:   The raw rating data, with user strings converted to numeric IDs, is in this file.

## Extracted Rating Tables

`az2014/az-cluster-ratings.parquet`{#file:az-cluster-ratings.parquet}
:   This file contains the integrated Amazon ratings, with cluster IDs in the `item` column.

`az2018/az-cluster-ratings.parquet`{#file:az-cluster-ratings.parquet}
:   This file contains the integrated Amazon ratings, with cluster IDs in the `item` column.
