...
`edition-isbn-ids`
:   Convert edition ISBNs into [ISBN IDs](isbn-id), producing `openlib/edition-isbn-ids.parquet`{.file}.
...
`openlibrary/editions.parquet`{#file-openlibrary-editions-parquet}
:   This file contains a primary record for each edition, with the numeric edition ID, OpenLibrary key,
and edition data.


`openlibrary/edition-authors.parquet`{#file-openlibrary-edition-authors-parquet}
:   This file contains mappings between editions and their authors.


`openlibrary/edition-works.parquet`{#file-openlibrary-edition-works-parquet}
:   This maps editions to their works.


`openlibrary/edition-isbns.parquet`{#file-openlibrary-edition-isbns-parquet}
...
`openlibrary/edition-subjects.parquet`{#file-openlibrary-edition-subjects-parquet}
...
`openlibrary/edition-isbn-ids.parquet`{#file-openlibrary-edition-isbn-ids-parquet}
:   This file maps editions to numeric [ISBN identifiers](isbn-id).  It is derived
from `openlibrary/edition-isbns.parquet`{.file}.
...
`openlibrary/works.parquet`{#file-openlibrary-works-parquet}
...
`openlibrary/work-authors.parquet`{#file-openlibrary-work-authors-parquet}
:   This file links work records to the work's author list (works may have separate author lists from their editions).


`openlibrary/work-subjects.parquet`{#file-openlibrary-work-subjects-parquet}
:   This table contains the subjects for OpenLibrary editions.  Each row contains an edition ID and one subject.
...
`openlibrary/authors.parquet`{#file-openlibrary-authors-parquet}
:   This file contains basic information about OpenLibrary authors.


`openlibrary/author-names.parquet`{#file-openlibrary-author-names-parquet}
:   This file contains the names associated with each author in `openlibrary/authors.parquet`{.file}.


## Utility Tables

`openlibrary/work-clusters.parquet`{#file-openlibrary-work-clusters-parquet}
