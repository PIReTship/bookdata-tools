...
`edition-isbn-ids`
:   Convert edition ISBNs into [ISBN IDs](isbn-id), producing {{< file edition-isbn-ids.parquet >}}.
...
`openlibrary/editions.parquet`{#file:editions.parquet}
:   This file contains a primary record for each edition, with the numeric edition ID, OpenLibrary key,
and edition data.


`openlibrary/edition-authors.parquet`{#file:edition-authors.parquet}
:   This file contains mappings between editions and their authors.


`openlibrary/edition-works.parquet`{#file:edition-works.parquet}
:   This maps editions to their works.


`openlibrary/edition-isbns.parquet`{#file:edition-isbns.parquet}
...
`openlibrary/edition-subjects.parquet`{#file:edition-subjects.parquet}
...
`openlibrary/edition-isbn-ids.parquet`{#file:edition-isbn-ids.parquet}
...
`openlibrary/works.parquet`{#file:works.parquet}
