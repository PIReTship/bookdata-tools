...
`book-links`
:   Creates `goodreads/gr-book-link.parquet`{.file}, which links each GoodReads book with its work (if applicable) and is cluster ID.
...
`goodreads/gr-book-ids.parquet`{#file-goodreads-gr-book-ids-parquet}
:   Identifiers extracted from each GoodReads book record.


`goodreads/gr-book-info.parquet`{#file-goodreads-gr-book-info-parquet}
:   Metadata extracted from GoodReads book records.


`goodreads/gr-book-genres.parquet`{#file-goodreads-gr-book-genres-parquet}
:   GoodReads book-genre associations.


`goodreads/gr-book-series.parquet`{#file-goodreads-gr-book-series-parquet}
:   GoodReads book series associations.


`goodreads/gr-genres.parquet`{#file-goodreads-gr-genres-parquet}
:   The genre labels to go with `goodreads/gr-book-genres.parquet`{.file}.


`goodreads/gr-book-link.parquet`{#file-goodreads-gr-book-link-parquet}
:   Linking identifiers (work and cluster) for GoodReads books.


`goodreads/gr-work-info.parquet`{#file-goodreads-gr-work-info-parquet}
:   Metadata extracted from GoodReads work records.


`goodreads/simple/gr-interactions.parquet`{#file-goodreads-simple-gr-interactions-parquet}
:   GoodReads interaction records (from CSV).


`goodreads/full/gr-interactions.parquet`{#file-goodreads-full-gr-interactions-parquet}
:   GoodReads interaction records (from JSON).


`goodreads/gr-author-info.parquet`{#file-goodreads-gr-author-info-parquet}
:   GoodReads author information.


## Cluster-Level Tables

`goodreads/full/gr-cluster-actions.parquet`{#file-goodreads-full-gr-cluster-actions-parquet}
...
`goodreads/full/gr-cluster-ratings.parquet`{#file-goodreads-full-gr-cluster-ratings-parquet}
...
`goodreads/simple/gr-cluster-actions.parquet`{#file-goodreads-simple-gr-cluster-actions-parquet}
...
`goodreads/simple/gr-cluster-ratings.parquet`{#file-goodreads-simple-gr-cluster-ratings-parquet}
...
`goodreads/full/gr-work-actions.parquet`{#file-goodreads-full-gr-work-actions-parquet}
:   Work-level implicit-feedback records, suitable for use in LensKit. The `item` column contains work IDs.


`goodreads/full/gr-work-ratings.parquet`{#file-goodreads-full-gr-work-ratings-parquet}
:   Work-level explicit-feedback records, suitable for use in LensKit. The `item` column contains work IDs.


`goodreads/simple/gr-work-actions.parquet`{#file-goodreads-simple-gr-work-actions-parquet}
:   Work-level implicit-feedback records, suitable for use in LensKit. The `item` column contains work IDs.


`goodreads/simple/gr-work-ratings.parquet`{#file-goodreads-simple-gr-work-ratings-parquet}
:   Work-level explicit-feedback records, suitable for use in LensKit. The `item` column contains work IDs.


`goodreads/gr-work-gender.parquet`{#file-goodreads-gr-work-gender-parquet}
:   Author gender for GoodReads works.  This is computed by connecting works to clusters and obtaining the cluster gender information from `book-links/cluster-genders.parquet`{.file}.
