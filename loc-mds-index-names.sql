CREATE INDEX locmds.name_marc_field_rec_idx ON locmds.name_marc_field (rec_id);
...
CREATE INDEX locmds.author_gender_rec_idx ON locmds.author_gender (rec_id);
...
CREATE INDEX locmds.author_name_rec_idx ON locmds.author_name (rec_id);
CREATE INDEX locmds.author_name_idx ON locmds.author_name (name);
