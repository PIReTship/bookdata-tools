...
const queries = {
  amazon: 'SELECT user_id, book_id, rating FROM az_export_ratings',
  'bx-explicit': 'SELECT user_id, book_id, rating FROM bx_explicit_ratings',
  'bx-all': 'SELECT user_id, book_id, rating FROM bx_all_ratings'
};
