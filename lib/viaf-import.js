...
function parseRecord(rec, enc, callback) {
  ...
  this.push({
    text: 'INSERT INTO viaf_author (viaf_au_key) VALUES ($1)',
    name: 'insert-author',
    values: [rec.id]
  });
  ...
  for (let df of root.children) {
    ...
    if (df.attributes.tag == '700') {
      // Author Name
      this.push({
        text: 'INSERT INTO (viaf_au_id, viaf_au_name, viaf_au_name_type, viaf_au_name_dates, viaf_au_name_source) ' +
              'SELECT viaf_au_id, $2, $3, $4, $5 FROM viaf_author WHERE viaf_au_key = $1',
      ...
      // Author Gender
      this.push({
        text: 'INSERT INTO (viaf_au_id, viaf_au_gender, viaf_au_gender_start, viaf_au_gender_end, viaf_au_gender_source) ' +
              'VALUES viaf_au_id, $2, $3, $4, $5 FROM viaf_author WHERE viaf_au_key = $1',
        name: 'insert-author-name',
