...
impl Node {
  #[inline]
  fn named<S: Into<String>>(s: S) -> Node {
    Node::Named(s.into())
  }

  #[inline]
  fn blank<S: Into<String>>(s: S) -> Node {
    Node::Blank(s.into())
  }
}
...
impl Term {
  #[inline]
  #[cfg(test)]
  fn named<S: Into<String>>(s: S) -> Term {
    Term::Node(Node::named(s))
  }

  #[inline]
  #[cfg(test)]
  fn blank<S: Into<String>>(s: S) -> Term {
    Term::Node(Node::blank(s))
  }

  #[inline]
  fn literal<V: Into<String>>(s: V) -> Term {
  ...
  #[cfg(test)]
  fn literal_lang<V: Into<String>, L: Into<String>>(s: V, lang: L) -> Term {
    Term::Literal(Literal {
      value: s.into(),
      lang: Some(lang.into()),
      schema: None
  ...
  #[cfg(test)]
  fn literal_schema<V: Into<String>, S: Into<String>>(s: V, schema: S) -> Term {
    Term::Literal(Literal {
      value: s.into(),
      lang: None,
...
impl Triple {
  /// Return a designated ‘empty’ triple.
  fn empty() -> Triple {
    Triple {
